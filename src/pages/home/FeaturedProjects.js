...
const FeaturedProjects = () => (
  <>
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ height: 1, flex: 1, bgcolor: 'rgba(255,255,255,0.09)' }} />
        </Box>
        ...
        >
          ...
          >
            <Typography
              variant="caption"
              sx={{ color: 'primary.main', letterSpacing: '0.12em', textTransform: 'uppercase' }}
            >
            ...
            <Box>
              <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1.5, flexWrap: 'wrap' }}>
                ...
                <Typography variant="body2" sx={{ color: '#5CD69B', fontWeight: 600 }}>
                  {HOME_STATS[0].detail}
                </Typography>
              </Box>
              ...
              <Box sx={{ mt: 3, height: 3, bgcolor: 'rgba(255,255,255,0.08)', overflow: 'hidden' }}>
                <Box
            ...
            {HOME_STATS.slice(1).map((stat, index) => (
              ...
              >
                ...
                <Box>
                  <Typography
                    variant="caption"
                    sx={{ color: 'primary.main', letterSpacing: '0.1em', textTransform: 'uppercase' }}
                  >
                    {stat.eyebrow}
                  </Typography>
    ...
    <Box component="section" sx={{ py: { xs: 8, md: 10 }, bgcolor: '#0B1016' }}>
      <Container maxWidth="lg">
        <Box
          sx={{
            mb: { xs: 4, md: 6 },
        ...
        >
          <Typography
            variant="body2"
            sx={{ color: 'primary.main', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', mb: 1.5 }}
          >
            Selected work
          </Typography>
        ...
        <Box sx={{ display: 'grid', gap: { xs: 5, md: 8 } }}>
          {FEATURED_PROJECTS.map(({ project, summary }, index) => (
            ...
            >
              <Box sx={{ order: { md: index % 2 === 1 ? 2 : 1 } }}>
                <ProjectVisual project={project} index={index} />
              </Box>

              <Box sx={{ order: { md: index % 2 === 1 ? 1 : 2 }, px: { md: 2 } }}>
                ...
                <Typography
                  ...
                  sx={{ mb: 2.25, maxWidth: 460, fontSize: { md: '1.05rem' } }}
                >
                  {summary}
                </Typography>
                ...
                <Button
                  ...
                  sx={{ minHeight: 0, p: 0, color: 'text.primary', '&:hover': { bgcolor: 'transparent', color: 'primary.main' } }}
                >
                  Read the case study
                </Button>
              </Box>
    ...
    <Box component="section" sx={{ py: { xs: 7, md: 9 }, bgcolor: '#0F161D' }}>
      <Container maxWidth="lg">
        <Box sx={{ mb: { xs: 4, md: 5 } }}>
          <Typography
            variant="body2"
          ...
          {principles.map((principle, index) => (
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 270 }}>
                  {principle.text}
                </Typography>
              </Box>
            </Box>
